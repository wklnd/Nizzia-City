// NPC hustle handlers: education, casino, real estate, business, pets, market, and items.
// Logic stays inline to avoid save conflicts with NPC tick bulk saves.
...
// Education: complete finished courses and enroll in the next eligible one.
...
async function handleEducation(player) {
  ...
  try {
    ...
    // Step 2: enroll in the next course.
