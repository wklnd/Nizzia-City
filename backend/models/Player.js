...
const playerSchema = new mongoose.Schema({
  ...
  // Player-supplied remote image links (no uploads). Up to 10 links.
  profileImages: {
    type: [{
      type: String,
      trim: true,
      validate: {
        ...
        message: 'Profile image must be a valid http(s) URL',
      },
    }],
    default: [],
    validate: {
      validator: (arr) => Array.isArray(arr) && arr.length <= 10,
      message: 'Profile images cannot exceed 10 links',
    },
  },
